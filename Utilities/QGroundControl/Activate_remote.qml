...
Item {
    ...
    Column {
        ...
        QGCButton {
            text: "Activate remote"
            onClicked: controller.sendCommand(208, 50, 0, 1, 0, 0, 0, 0, 0, 0)
        }
        QGCButton {
            text: "Disactivate remote"
            onClicked: controller.sendCommand(208, 50, 0, 0, 0, 0, 0, 0, 0, 0)
        }
